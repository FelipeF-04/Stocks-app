...
def quote():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            return render_template("quoted.html", results=results, graph=image_base64)
            
        except Exception as e:
            # If chart generation fails, still return the quote without the chart
            print(f"Chart generation error: {e}")
            return render_template("quoted.html", results=results, graph=None)
